...
<div class="col-lg-12">
  <div class="card">
    ...
    <div class="card-body pt-0">
      ...
      <form id="alb_form" class="needs-validation" action="./up/alb_up.php?id=<?php echo $id; ?>" method="POST"
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <svg id="default_cov" xmlns="http://www.w3.org/2000/svg" class="w-100 mt-0" viewBox="0 0 24 24"
            ...
            <div class="has-validation">
              <input type="file" name="cover_alb" class="form-control mt-3" aria-label="alb_cov" required
                id="alb_cov_in" accept=""></input>
          ...
          <div class="col-md-9 mb-3">
            <div class="row">
              <div class="col-md-12 mt-0 mb-1">
                ...
                <div class="has-validation">
                  <input class="form-control" id="nm_alb" type="text" value='<?php echo $name_a ?>'
                    aria-describedby="nm_alb_help" required minlength="1" maxlength="50" size="50" name="nm_alb" />
              ...
              <div class="col-md-12 mb-1">
                ...
                <div class="has-validation">
                  <input class="form-control" id="date_alb" type="text" name="date_alb" value='<?php echo $date_alb ?>'
                    pattern="\d{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])" aria-describedby="date_alb_help"
                    required />
              ...
              <div class="col-md-2">
                ...
                <div class="has-validation">
                  <input class="form-control" id="totl_trck" type="number" name="totl_trck"
                    value="<?php echo $totl_trck ?>" aria-describedby="totl_trck_help" required min="1" max="99"
                    pattern="[0-9]{2}" />
              ...
              <div class="col-md-5">
                ...
                <div class="has-validation">
                  <input class="form-control" id="gen_alb" type="text" name="gen_alb" value="<?php echo $gen_alb ?>"
                    aria-describedby="gen_alb_help" required maxlength="100" />
              ...
              <div class="col-md-2">
                ...
                <div class="has-validation">
                  <input class="form-control" id="punct_alb" type="number" name="punct_alb" min="0.0" max="10.0"
                    step=".1" value="<?php echo $punct ?>" aria-describedby="punct_alb_help" required />
              ...
              <div class="col-md-3">
                ...
                <div class="has-validation">
                  <input class="form-control" name="price_alb" id="price_alb" type="number" value="<?php echo $price ?>"
                    min="0.01" max="999.99" step="000.01" aria-describedby="price_alb_help" required />
              ...
              <div class="col-md-12 mt-2">
                ...
                <div class="has-validation">
                  <textarea class="form-control" name="note_alb" id="note_alb" aria-label="note" rows="8"
                    aria-describedby="note_alb_help" required><?php echo $note ?></textarea>
