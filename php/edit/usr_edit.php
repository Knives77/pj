...
if (isset($_GET["id"])) {
    $id = $_GET["id"];
    $sql = "SELECT * FROM users where id_usr = $id";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $name_usr =  $row["name_usr"];
        $ap_p_usr =  $row["ap_p_usr"];
        $ap_m_usr = $row["ap_m_usr"];
        $age = $row["age"];
        $gen = $row["gen"];
        $street = $row["street"];
        $num_house = $row["num_house"];
...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body pt-0">
            ...
            <form id="usr_form" class="needs-validation" action="./up/usr_up.php?id=<?php echo $id;?>" method="POST"
                ...
                <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11;">
                    <div id="liveToast" class="toast hide" role="alert" aria-live="assertive" aria-atomic="true"
                        ...
                        <div class="toast-header" style="background-color: rgba(255, 255, 255, .1);">
                            ...
                            <small><a href="../tables/dist/user_table.php"><svg xmlns="http://www.w3.org/2000/svg"
