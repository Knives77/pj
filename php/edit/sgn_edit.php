...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body pt-0">
            ...
            <form id="sgn_form" class="needs-validation" action="./up/sgn_up.php?id=<?php echo $id;?>" method="POST"
        ...
        <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11;">
            <div id="liveToast" class="toast hide" role="alert" aria-live="assertive" aria-atomic="true"
                ...
                <div class="toast-header" style="background-color: rgba(255, 255, 255, .1);">
                    ...
                    <small><a href="../tables/dist/song_table.php"><svg xmlns="http://www.w3.org/2000/svg" width="24"
