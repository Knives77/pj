...
$song_sales_query = "SELECT * FROM song_sales";
$song_sales_result = mysqli_query($conn, $song_sales_query);
?>
    ...
    <div class="card mb-0">
        ...
        <div class="card-body pt-0">
            ...
            <table class="table mb-0 table-striped table-sm table-hover" id="song_sales_t">
                    ...
                    <tbody>
                        <?php
                        if ($song_sales_result->num_rows > 0) {
                            while ($song_sale_row = $song_sales_result->fetch_assoc()) {
                                echo "
                                   <tr>
                                     ...
                                     <td class='text-center align-middle'><button class='btn btn-secondary tde' type='button' value='" . $song_sale_row['id_sale'] . ", " . $album_sale_row['id_song'] . "' data-bs-toggle='modal' data-bs-target='#modal2' name='song_sales'>
                                     ...
                                     <td class='text-center align-middle'><button class='btn btn-danger tdd' type='button' value='" . $song_sale_row['id_sale'] . ", " . $album_sale_row['id_song'] . "' data-bs-toggle='modal' data-bs-target='#modal1' name='song_sales'>
