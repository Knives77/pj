                            ...
                            while ($song_sale_row = $song_sales_result->fetch_assoc()) {
                                echo "
                                   <tr>
                                     ...
                                     <td class='text-center align-middle'><button class='btn btn-danger tdd' type='button' value='" . $song_sale_row['id_sale'] . "' name='" . $song_sale_row['id_song'] . "' data-bs-toggle='modal' data-bs-target='#modal1'>
