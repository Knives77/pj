    ...
    <div class="card mb-0">
        ...
        <div class="card-body pt-0">
            <div class="table-responsive">
                <table class="table mb-0 table-striped table-sm table-hover" id="users_t">
                    <thead>
                        <tr>
                            <th>ID Usuario</th>
                            <th>Nombre</th>
                    ...
                    <tbody>
                        ...
                        if ($usersResult->num_rows > 0) {
                            while ($userRow = $usersResult->fetch_assoc()) {
                                echo "
                   <tr>
                     <th scope='row'>" . $userRow['id_usr'] . "</th>
                     <td class='align-middle'>" . $userRow['name_usr'] . "</td>
                     <td>" . $userRow['ap_p_usr'] . "</td>
                     <td>" . $userRow['ap_m_usr'] . "</td>
                     <td>" . $userRow['age'] . "</td>
                     <td>" . $userRow['gen'] . "</td>
                     <td>" . $userRow['street'] . "</td>
                     <td>" . $userRow['num_house'] . "</td>
                     <td>" . $userRow['code_post'] . "</td>
                     <td>" . $userRow['colony'] . "</td>
                     <td>" . $userRow['munic'] . "</td>
                     <td>" . $userRow['state'] . "</td>
                     <td>" . $userRow['phone_n'] . "</td>
                     <td>" . $userRow['email'] . "</td>
                     <td>" . $userRow['psswd'] . "</td>
                     <td class='text-center align-middle'><button class='btn btn-secondary tde' type='button' value='" . $userRow['id_usr'] . "' data-bs-toggle='modal' data-bs-target='#modal2' name='users'>
                     ...
                     <button class='btn btn-danger tdd' type='button' value='" . $userRow['id_usr'] . "' data-bs-toggle='modal' data-bs-target='#modal1' name='users'>
