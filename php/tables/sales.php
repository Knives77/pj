    ...
    <div class="card mb-0">
        ...
        <div class="card-body pt-0">
            <div class="table-responsive">
                <table class="table mb-0 table-striped table-sm table-hover" id="sales_t">
                    <thead>
                        <tr>
                            <th>ID Venta</th>
                            <th>ID Usuario</th>
                    ...
                    <tbody>
                        ...
                        if ($sales_result->num_rows > 0) {
                            while ($sale_row = $sales_result->fetch_assoc()) {
                                echo "
                                   <tr>
                                     <th scope='row'>" . $sale_row['id_sale'] . "</th>
                                     <td class='align-middle'>" . $sale_row['id_usr'] . "</td>
                                     <td class='align-middle'>" . $sale_row['keyword'] . "</td>
                                     <td>" . $sale_row['date_sale'] . "</td>
                                     <td>" . $sale_row['mode_sale'] . "</td>
                                     <td>$" . $sale_row['ttl_sale'] . "</td>
                                     <td>" . $sale_row['payment_type'] . "</td>
                                     <td>" . $sale_row['warranty_months'] . "</td>
                                     <td>" . ($sale_row['various_prdct'] ? 'Sí' : 'No') . "</td>
                                     <td class='text-center align-middle'><button class='btn btn-secondary tde' type='button' value='" . $sale_row['id_sale'] . "' data-bs-toggle='modal' data-bs-target='#modal2' name='sales'>
                                         ...
                                         <td class='text-center align-middle'><button class='btn btn-danger tdd' type='button' value='" . $sale_row['id_sale'] . "' data-bs-toggle='modal' data-bs-target='#modal1' name='sales'>
