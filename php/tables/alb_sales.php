                            ...
                            while ($album_sale_row = $album_sales_result->fetch_assoc()) {
                                echo "
                                   <tr>
                                     ...
                                     <td class='text-center align-middle'><button class='btn btn-secondary tde' type='button' value='" . $album_sale_row['id_sale'] . ", " . $album_sale_row['id_alb'] . "' data-bs-toggle='modal' data-bs-target='#modal2' name='album_sales'>
                                     ...
                                     <td class='text-center align-middle'><button class='btn btn-danger tdd' type='button' value='" . $album_sale_row['id_sale'] . ", " . $album_sale_row['id_alb'] . "' data-bs-toggle='modal' data-bs-target='#modal1' name='albums_sales'>
