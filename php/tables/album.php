              ...
              while ($row = $res->fetch_assoc()) {
                echo "
                   <tr>
                     ...
                     <a href='./php/deletes/alb_del.php?id=" . $row['id_alb'] . "' class='btn btn-danger' style='background-color: #dc3545; border-color: #dc3545;'><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' 
                     ...
                     </path><path d='M9 10h2v8H9zm4 0h2v8h-2z'></path></svg></a></td>-->

                     <td class='text-center align-middle'><button class='btn btn-danger tdd' type='button' value='" . $row['id_alb'] . "' data-bs-toggle='modal' data-bs-target='#modal1'>
